...
describe('UrlBuddyPsl', () => {
  describe('withTopLevelDomain()', () => {
    describe('with constant argument', () => {
      it('reassembles when no changes applied', () => {
        ...
        const resultUrl = urlmate(initialUrl).withTopLevelDomain('ua').toString();
    ...
    describe('with mapper argument', () => {
      ...
      it('reassembles when no changes applied', () => {
        const initialUrl = 'https://example.com/';
        const resultUrl = urlmate(initialUrl).withTopLevelDomain(appendUA).toString();
  ...
  describe('withSecondLevelDomain()', () => {
    describe('with constant argument', () => {
      it('reassembles when no changes applied', () => {
        const initialUrl = 'https://example.com/';
        const resultUrl = urlmate(initialUrl).withSecondLevelDomain('testing').toString();
    ...
    describe('with mapper argument', () => {
      ...
      it('reassembles when no changes applied', () => {
        const initialUrl = 'https://example.com/';
        const resultUrl = urlmate(initialUrl).withSecondLevelDomain(removeVowels).toString();
  ...
  describe('withSubdomain()', () => {
    describe('with constant argument', () => {
      it('reassembles when no changes applied', () => {
        const initialUrl = 'https://example.com/';
        const resultUrl = urlmate(initialUrl).withSubdomain('qa').toString();
    ...
    describe('with mapper argument', () => {
      ...
      it('reassembles when no changes applied', () => {
        const initialUrl = 'https://example.com/';
        const resultUrl = urlmate(initialUrl).withSubdomain(appendStage).toString();
